...
Permissions::Permissions(short octal, const char* user)
{
  permissions = octal & ~umask;
  ...
  else //else null user name from source
  {
    owner = NULL;
  } //else null user name
...
Permissions::Permissions(const Permissions &rhs) : permissions(rhs.permissions)
{
  ...
  } //if non-null user name from source
  else //else null user name from source
  {
    owner = NULL;
  } //null user name from source
